      ...
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        <thead>
          <tr style={{ backgroundColor: '#f2f2f2' }}>
            <th style={{ padding: '10px', border: '1px solid #ddd' }}>user_id</th>
            <th style={{ padding: '10px', border: '1px solid #ddd' }}>first_name</th>
            <th style={{ padding: '10px', border: '1px solid #ddd' }}>last_name</th>
